    ...
    <header className="header">
      ...
      <div className="header-top">
        ...
        <nav className="main-nav">
          <button type="button" className="nav-link-button">Vendors</button>
          <button type="button" className="nav-link-button">Promotions</button>
          <button type="button" className="nav-link-button">Brands</button>
          <button type="button" className="nav-link-button">Newest</button>
          <button type="button" className="nav-link-button">Bestsellers</button>
          <button type="button" className="nav-link-button">On Sale</button>
          <button type="button" className="nav-link-button">English</button>
        </nav>
      </div>
